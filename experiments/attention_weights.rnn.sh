...
python3 ~/returnn-parnia-2/tools/get-attention-weights.py ${CONFIG} --epoch ${EPOCH} --data config:newstest${YEAR} --dump_dir ${OUTPUT_FOLDER} --layers "att_weights" --rec_layer "output" --batch_size 600 "$@"
