...
python3 /u/makarov/returnn-hmm-fac/rnn.py $1 ++load_epoch $2 ++device 'gpu' --task 'search' ++search_data 'config:'$5 ++beam_size '12' ++need_data 'False' ++max_seq_length '0' ++search_output_file $3 &> $4$5
