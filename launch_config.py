...
def main(args):
    ...
    launch_command = "qsub -l gpu=1 -l h_rt=150:00:00 -l num_proc=5 -l h_vmem={}G -l qname='*1080*|*TITAN*' -m abe -cwd {} {}"
    launch_command = launch_command.format(args.memory, path_to_runner, args.p)
